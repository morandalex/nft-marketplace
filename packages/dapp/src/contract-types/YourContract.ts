...
export interface YourContractInterface extends utils.Interface {
  functions: {
    ...
    "createNft(string,uint256,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "MarketItemCreated(uint256,address,address,address,uint256,uint256,bool)": EventFragment;
...
export type MarketItemCreatedEvent = TypedEvent<
  [BigNumber, string, string, string, BigNumber, BigNumber, boolean],
  {
    tokenId: BigNumber;
    creator: string;
    seller: string;
...
export interface YourContract extends BaseContract {
  ...
  filters: {
    ...
    "MarketItemCreated(uint256,address,address,address,uint256,uint256,bool)"(
      tokenId?: BigNumberish | null,
      creator?: null,
      seller?: null,
      owner?: null,
